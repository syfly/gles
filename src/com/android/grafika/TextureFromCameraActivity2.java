...
public class TextureFromCameraActivity2 extends Activity implements SurfaceHolder.Callback,
        SeekBar.OnSeekBarChangeListener, Choreographer.FrameCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_texture_from_camera2);
        ...
        mRecordButton = (Button) findViewById(R.id.tfcrecord_button);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        File outputFile = new File( "/sdcard/Movies/test-recording.mp4");//bhl

        mRenderThread = new RenderThread(sSurfaceHolder,new MainHandler(this),outputFile,MiscUtils.getDisplayRefreshNsec(this));
...
//        }
    ...
    private void updateControls() {
        ...
        tv.setText(str);
        Button toggleRelease = (Button) findViewById(R.id.tfcrecord_button);
    ...
    private static class MainHandler extends Handler {
        ...
        private static final int MSG_UPDATE_FPS = 5;
    ...
    private static class RenderThread extends Thread implements
     ...
     // Previous frame time.
        ...
        private final Sprite2d mRect = new Sprite2d(new Drawable2d(Drawable2d.Prefab.RECTANGLE));
         ...
         * Activity.
         */
        public RenderThread(SurfaceHolder holder, MainHandler handler, File outputFile,
        ...
        private void surfaceAvailable(SurfaceHolder holder, boolean newSurface) {
            ...
            Log.d(TAG, "surfaceAvailable textureId" + textureId);
        ...
        private void prepareFramebuffer(int width, int height) {
            ...
            Log.d(TAG, "prepareFramebuffer mOffscreenTexture" + mOffscreenTexture);
...
//                            mVideoRect.width(), mVideoRect.height());
                    ...
                    mFullScreen2.drawFrame(mOffscreenTexture, mIdentityMatrix);
...
//            mWindowSurface.swapBuffers();
        ...
        private void startEncoder() {
            ...
            try {
                encoderCore = new VideoEncoderCore(1080, 1920,
                        BIT_RATE, new File("/sdcard/output2.mp4")/*mOutputFile*/);
            } catch (IOException ioe) {
                throw new RuntimeException(ioe);
            }

...
//            Log.d(TAG,"mRotatePercent:"+mRotatePercent);
//            Log.d(TAG,"rotAngle:"+rotAngle);
            newWidth = mWindowSurfaceHeight;
            newHeight = mWindowSurfaceWidth;
            mRect.setScale(newWidth, newHeight);
            mRect.setPosition(mPosX, mPosY);
            Log.d(TAG,"newWidth:"+newWidth+" newHeight:" + newHeight + " mPosX:"+mPosX +" mPosY:"+mPosY);
        ...
        private void frameAvailable() {
            ...
            if (!mRecordingEnabled || mRecordedPrevious) {
                ...
                if (mEglCore.getGlVersion() >= 4) {
                    ...
                    Log.d(TAG, "glBlitFramebuffer: 0,0," + mWindowSurface.getWidth() + "," +
...
//                            GLES30.GL_COLOR_BUFFER_BIT, GLES30.GL_NEAREST);
                    GLES30.glBlitFramebuffer(
                            0, 0, mWindowSurface.getHeight(), mWindowSurface.getWidth(),
                            0, 0, mWindowSurface.getHeight(), mWindowSurface.getWidth(),
                            GLES30.GL_COLOR_BUFFER_BIT, GLES30.GL_NEAREST);
                    int err;
                    ...
                    int windowSurfaceWidth = mWindowSurface.getWidth();
                    int windowSurfaceHeight = mWindowSurface.getHeight();
...
//            mWindowSurface.swapBuffers();
        ...
        private void stopEncoder() {
            ...
            Log.d(TAG,"frame_count:"+frame_count);
